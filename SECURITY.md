...
RazorBackRoar takes security seriously. This policy applies to **Looper** and matches the organization-wide standard used across RazorBackRoar product repositories.
...
1. **GitHub Private Vulnerability Reporting** — use [Report a vulnerability](https://github.com/RazorBackRoar/Looper/security/advisories/new) on this repository when enabled.
2. **Maintainer contact** — email the maintainer using the address on their [GitHub profile](https://github.com/RazorBackRoar) with a clear subject such as `SECURITY: Looper`.
...
- Unexpected local file access outside the opened media path
- Secrets or credentials committed to the repository
- Unsafe handling of untrusted media that leads to code execution
...
Please use [GitHub Issues](https://github.com/RazorBackRoar/Looper/issues) for ordinary bugs and feature requests.
